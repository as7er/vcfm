// Reuse the previously audited back-line/outlet geometry with no parameter
// changes. Keep it separate from rejected carry and moving-pressure experiments.
...
reportCandidateOnExit(() => ({ backlineSupportCandidate: { loadedEngineSha256 } }));
