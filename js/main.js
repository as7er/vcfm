...
import { nationFlagHtml } from "./flags.js?v=277";
import { clubCrestHtml } from "./club-crest.js?v=277";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=277").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
