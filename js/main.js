...
import { nationFlagHtml } from "./flags.js?v=274";
import { clubCrestHtml } from "./club-crest.js?v=274";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=274").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
