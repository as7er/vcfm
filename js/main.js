...
import { nationFlagHtml } from "./flags.js?v=279";
import { clubCrestHtml } from "./club-crest.js?v=279";
...
function loadMatchViewModule() {
  ...
  matchViewModulePromise = import("./matchview.js?v=279").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
