...
import { nationFlagHtml } from "./flags.js?v=250";
import { clubCrestHtml } from "./club-crest.js?v=250";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=250").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
