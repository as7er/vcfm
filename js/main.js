...
import { nationFlagHtml } from "./flags.js?v=278";
import { clubCrestHtml } from "./club-crest.js?v=278";
...
function loadMatchViewModule() {
  ...
  matchViewModulePromise = import("./matchview.js?v=278").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
