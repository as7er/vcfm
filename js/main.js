...
import { nationFlagHtml } from "./flags.js?v=249";
import { clubCrestHtml } from "./club-crest.js?v=249";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=249").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
