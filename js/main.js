...
import { nationFlagHtml } from "./flags.js?v=251";
import { clubCrestHtml } from "./club-crest.js?v=251";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=251").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
