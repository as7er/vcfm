...
import { nationFlagHtml } from "./flags.js?v=248";
import { clubCrestHtml } from "./club-crest.js?v=248";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=248").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
