...
import { nationFlagHtml } from "./flags.js?v=285";
import { clubCrestHtml } from "./club-crest.js?v=285";
...
function loadMatchViewModule() {
  ...
  matchViewModulePromise = import("./matchview.js?v=285").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
