...
import { nationFlagHtml } from "./flags.js?v=252";
import { clubCrestHtml } from "./club-crest.js?v=252";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=252").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
