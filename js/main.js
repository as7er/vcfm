...
import { nationFlagHtml } from "./flags.js?v=263";
import { clubCrestHtml } from "./club-crest.js?v=263";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=263").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
