...
import { nationFlagHtml } from "./flags.js?v=253";
import { clubCrestHtml } from "./club-crest.js?v=253";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=253").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
