...
import { nationFlagHtml } from "./flags.js?v=254";
import { clubCrestHtml } from "./club-crest.js?v=254";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=254").then((module) => {
      matchViewApi = module;
      return module;
    });
  }
