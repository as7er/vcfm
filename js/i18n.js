...
const dict = {
  zh: {
    ...
    "start.detectSave": "检测到存档（当前槽 {n}），可读取继续。换设备请先导出。",
    ...
    // transfer
    "tr.market": "转会市场",
    "tr.hint": "夏窗 D1–D35 · 冬窗 D120–D145；窗外无法买卖（AI 同样受限）。",
    "tr.allPos": "全部位置",
    "tr.refresh": "刷新列表",
    "tr.sell": "可出售球员",
    "pos.GK": "门将",
  ...
  en: {
    ...
    "start.detectSave": "Save found (slot {n}). Load to continue, or export first if moving devices.",
    ...
    "tr.hint": "Summer D1–35 · Winter D120–145. No buys/sells outside the window (AI included).",
