...
const dict = {
  zh: {
    ...
    "tac.width": "进攻宽度",
    "tac.defLine": "防线高度",
    "tac.hint": "阵型、风格与滑条会影响攻防、控球、犯规与体能；风格之间存在克制。",
    "tac.pitchHint": "拖拽互换首发，或把替补拖上场；点名牌可查看资料。首发会尽量保留到开球。",
    "tac.bench": "替补席",
  ...
  en: {
    ...
    "tac.hint": "Formation, style and sliders affect attack/defence, possession, fouls and fitness. Styles counter each other.",
    "tac.pitchHint": "Drag to swap starters or drop bench onto a slot. Name opens profile. XI kept at kick-off.",
    "tac.bench": "Bench",
